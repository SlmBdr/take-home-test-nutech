...
window.onload = function () {
  ...
  var options = {
    "swaggerDoc": {
      ...
      "servers": [
        {
          "url": "https://take-home-test-nutech-production-bc01.up.railway.app",
                ...
                "application/json": {
                  "schema": {
                    ...
                    "properties": {
                      "email": {
                        "type": "string",
                        "description": "Email User yang telah diregistrasi"
                      },
                      "password": {
                        "type": "string",
                        "description": "Password User yang telah diregistrasi"
                      }
                    },
                    "example": {
                      "email": "user@nutech-integrasi.com",
                  ...
                  "application/json": {
                    "schema": {
                      ...
                      "properties": {
                        ...
                        "data": {
                          "type": "object",
                          "description": "Contains information about list my cart"
                        }
                      },
                      "example": {
                        "status": 0,
                  ...
                  "application/json": {
                    "schema": {
                      ...
                      "properties": {
                        ...
                        "data": {
                          "type": "object",
                          "description": "Berisi list banner"
                        }
                      },
                      "example": {
                        "status": 0,
                  ...
                  "application/json": {
                    "schema": {
                      ...
                      "properties": {
                        ...
                        "data": {
                          "type": "object",
                          "description": "Berisi informasi Balance User"
                        }
                      },
                      "example": {
                        "status": 0,
          ...
          "get": {
            ...
            "parameters": [
              ...
              },
              {
                ...
                "schema": {
                  "type": "integer",
                  "description": "Limit Data History Transaksi",
                  "example": 3
                }
              }
            ],
